...
$db = mysqli_connect('localhost', 'root', '', 'fashion_retail');
...
function cart_items()
{
    ...
    <div class='card col-md-3 col-10' style='margin:0 auto; border-radius:25px 5px;box-shadow: inset -12px -8px 40px #e5e5e5;'>
        ...
        <tr style='border-bottom: 0.5px solid #ebebeb'>
           ...
           <td class='p-price first-row'>RWF $pro_price</td>
           ...
           <td class='total-price first-row'>RWF $pro_total_p</td>
